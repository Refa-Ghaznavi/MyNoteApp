...
public class  CreateNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // for removing imageRemoveWebURL
    ...
    private void saveNote() {
        ...
        // here wer are setting id of new note from an already available note
        // since we have set onClick Strategy to "REPLACE" in noteDao
    ...
    private void iniMiscellaneous() {
        ...
        /*
        * here if alreadyAvailableNote is not null then it means the user is viewing or updating already
        * added note form the database and therefore we are displaying delete note option
        * */
        if(alreadyAvailableNote != null){
